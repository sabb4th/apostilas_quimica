...
\newcommand{\titulo}{7\textsuperscript{a} Lista de Exercícios: Cálculo Estequiométrico}
...
\question \citep{ENEM(2018)} Objetos de prata sofrem escurecimento devido à sua reação com enxofre. Estes materiais recuperam seu brilho característico quando envoltos por papel alumínio e mergulhados em um recipiente contendo água quente e sal de cozinha.

A reação não balanceada que ocorre é:

	$$Ag_{2}S + Al  \rightarrow Al_{2}S_{3} + Ag $$

Utilizando o processo descrito, a massa de prata metálica que será regenerada na superfície de um objeto que contém 2,48 g de $Ag_{2}S$ é
...
\question \citep{ENEM(2015)} O cobre presente nos fios elétricos e instrumentos musicais é obtido a partir da ustulação do minério calcocita ($Cu_{2}S$). Durante esse processo, ocorre o aquecimento desse sulfeto na presença de oxigênio, de forma que o cobre fique “livre” e o enxofre se combine com o $O_{2}$ produzindo $SO_{2}$, conforme a equação química:

	$$Cu_{2}S  + O_{2} \rightarrow 2 \, Cu  + SO_{2}$$

onsiderando que se queira obter 16 mols do metal em uma reação cujo rendimento é de $80\%$, a massa, em gramas, do minério necessária para obtenção do cobre é igual a
